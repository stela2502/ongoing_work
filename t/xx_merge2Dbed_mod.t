...
$exp = [
	[
		qw(Features	/home/stefan/git/ongoing_work/t/data/EBF1.tiny.bed	/home/stefan/git/ongoing_work/t/data/IKZF1.tiny.bed	Name)
	],
...
is_deeply( [ @$err[ 10 .. 13 ] ], $exp, "error file correct" );
...
$exp = [
	[
		...
		'IKZF1.tiny.bed [n]',    'EBF1.tiny.bed: info 1',
		'EBF1.tiny.bed: info 2', 'IKZF1.tiny.bed: info 1',
		'IKZF1.tiny.bed: info 2'
	],
	[
